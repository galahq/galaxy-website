      ...
      <PaddedRunningTextContainer>
        ...
        <p>
          <KeySentence>
            ...
            (MSC) began with the ambition to create a new kind of teaching case,
            co-designed for contributing solutions to real-world challenges.
          </KeySentence>
        </p>
        <p>
          ...
          and from Kathmandu to Kalamazoo, we realized these cases could be used
          across communities and organizations where lifelong learners confront
        ...
        <p>
          ...
          needed a tool to help us foster generous collaborations and make them
          shine. Enter Gala.
        </p>
        ...
        <p>
          ...
          generation, gender, or other metrics can foster inclusivity), in-line
          discussion forums (a conversation board sits on top of each case for
          nuanced, updated information), Caselog (an open exchange of teaching
          insights to allow creative implementation and effective learning
